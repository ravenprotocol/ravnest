...
'''
The following code for the Inception V3 model has been taken from:
https://github.com/huyvnphan/PyTorch_CIFAR10/blob/master/cifar10_models/inception.py

References: Rethinking the Inception Architecture for Computer Vision <http://arxiv.org/abs/1512.00567>
'''
